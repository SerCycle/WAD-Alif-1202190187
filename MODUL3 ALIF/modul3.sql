...
--
-- Host: localhost:3316
-- Generation Time: Nov 21, 2021 at 03:27 PM
...
(39, 'buku manga', 'Alif_1202190187', 2009, 'ini buku untuk para wibu', 'Mizuhara.Chizuru.full.jpg', 'Lainnya', 'Lainnya');
...
--
ALTER TABLE `buku_table`
  MODIFY `id_buku` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
COMMIT;
