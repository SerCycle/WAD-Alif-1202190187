            ...
            <ul type="none">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="p-3">
                        ...
                        <li class="mb-2">
                            <label class="mb-2 me-2" for="bahasa"><b>Bahasa</b></label>
                        ...
                        <li class="mb-2">
                            <label class="mb-2 me-2" for="tag"><b>Tag</b></label>
                            <div class="form-check form-check-inline">
                        ...
                        <li class="mb-2">
                            <label class="mb-2" for="gambar"><b>Gambar</b></label>
                            <input class="form-control" type="file" name="gambar" id="gambar">
                        </li>
                        <li class="text-center pt-2 mb-2">
